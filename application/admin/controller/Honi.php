    ...
    public function delete(){
        ...
        if ($type==2){
            if ($id>1){
                ...
                $temege_model->delete_honiInfo(array('id'=>$id));
                /** 用上一级id作为引导 */
                $this->success('删除成功','/admin.php/admin/honi/index?id='.$data['ParentId'],'',1);
            }
        }
        $this->redirect('/admin.php/admin/honi/index?id='.$id);
